...
{
    private static readonly Capability Rust = new Capability("RUST", "SKILL");
    private static readonly Capability BeingAnAdmin = new Capability("ADMIN", "PERMISSION");
    private static readonly Capability Java = new Capability("JAVA", "SKILL");
